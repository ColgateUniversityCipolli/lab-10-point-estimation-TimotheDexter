...
# Parameters for best-of-11 (win 6 legs)
x = 6; size = 11; prob = 0.5
theta_seq = seq(0.5, 1.5, by = 0.01)

# Compute probabilities and make data frame
probs = sapply(theta_seq, function(th) daltbinom(x, size, prob, th))
df = tibble(theta = theta_seq, prob_win = probs)

# ggplot with geom_line
ggplot(df, aes(x = theta, y = prob_win)) +
  geom_line(linewidth = 1, color = "blue") +
  labs(x = expression(theta), 
       y = "P(X = 6)",
       title = "Probability of Winning Exactly 6 of 11 Legs") +
  theme_minimal() +
